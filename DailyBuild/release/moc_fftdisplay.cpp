/****************************************************************************
** Meta object code from reading C++ file 'fftdisplay.h'
**
...
#include "../../ShadowPlayer/fftdisplay.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'fftdisplay.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FFTDisplay_t, stringdata) + ofs \
...
const QMetaObject FFTDisplay::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_FFTDisplay.data,
      qt_meta_data_FFTDisplay,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FFTDisplay.stringdata))
