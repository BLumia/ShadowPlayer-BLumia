...
public:
    Lyrics();
    bool resolve(QString fileName, bool isLrc = false);//歌词解析 ,isLrc：此文件是否为歌词文件，失败返回false
    bool loadFromLrcDir(QString fileName);
    bool loadFromFileRelativePath(QString fileName, QString path);
